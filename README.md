...
Currently, my npm install isn't running node-gyp, so I'm manually running the following commands after an npm install

node-gyp configure --nodedir=/home/stringa/.nvm/versions/node/v6.9.2
node-gyp build --nodedir=/home/stringa/.nvm/versions/node/v6.9.2
